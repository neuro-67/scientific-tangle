...
| [backend/SHARED_GRAPH_DB.md](./backend/SHARED_GRAPH_DB.md) | Как получить одну общую графовую БД у всей команды: VPS-деплой, перелив готовых графов без повторной LLM-экстракции, офлайн-дамп |
| [../nlp/README.md](../nlp/README.md) | **Статус реализации** ML-1/ML-2: LLM-провайдер (RouterAI fallback), выбор моделей по бенчмарку, найденные и исправленные баги, известные ограничения |
